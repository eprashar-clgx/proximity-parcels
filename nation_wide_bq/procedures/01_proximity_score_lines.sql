...
CREATE OR REPLACE PROCEDURE `clgx-gis-app-dev-06e3.proximity_parcels.calculate_proximity_score_lines_batch`(encumbrance_table STRING, encumbrance_id_col STRING)
BEGIN
  -- Constants
  ...
  FROM `clgx-gis-app-dev-06e3.proximity_parcels.parcels_mv`;
